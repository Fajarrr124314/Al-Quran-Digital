...
export const Footer: React.FC = () => {
  return (
    <footer className="border-t border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 backdrop-blur-md py-8 mt-20 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex flex-col items-center md:items-start gap-1">
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500">
            Data Al-Qur'an & Terjemahan disediakan oleh <a href="https://equran.id" target="_blank" rel="noreferrer" className="text-accent-primary hover:underline">equran.id</a>
          </p>
        </div>
